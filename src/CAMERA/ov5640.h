...
typedef enum
{
    OV5640_GET_TYPE_DTS_8B_NOINC = 0x00,
    OV5640_GET_TYPE_DTS_8B_INC,
    OV5640_GET_TYPE_DTS_16B_NOINC,
    OV5640_GET_TYPE_DTS_16B_INC,
    OV5640_GET_TYPE_DTS_32B_NOINC,
    OV5640_GET_TYPE_DTS_32B_INC,
} ov5640_get_type_t;
...
#define OV5640_CAM_PWR_ON                   (BSP_IO_PORT_07_PIN_10)
#define OV5640_CAM_RESET                    (BSP_IO_PORT_07_PIN_09)
#define OV5640_CAM_FLASH                    (BSP_IO_PORT_01_PIN_09)

extern uint32_t g_out_width;
extern uint32_t g_out_height;

#define OV5640_I2C_SLAVE_ADDR 0x78>>1
#define OV5640_QQVGA_WIDTH  (128U)
#define OV5640_QQVGA_HEIGHT (160U)
