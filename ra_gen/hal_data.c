...
sci_b_uart_instance_ctrl_t g_uart0_asrpro_ctrl;

sci_b_baud_setting_t g_uart0_asrpro_baud_setting =
        {
...
const sci_b_uart_extended_cfg_t g_uart0_asrpro_cfg_extend =
{ .clock = SCI_B_UART_CLOCK_INT, .rx_edge_start = SCI_B_UART_START_BIT_FALLING_EDGE, .noise_cancel =
  ...
  .rx_fifo_trigger = SCI_B_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &g_uart0_asrpro_baud_setting, .flow_control =
...
const uart_cfg_t g_uart0_asrpro_cfg =
{ .channel = 0, .data_bits = UART_DATA_BITS_8, .parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
          g_uart0_asrpro_callback,
  .p_context = NULL, .p_extend = &g_uart0_asrpro_cfg_extend,
...
const uart_instance_t g_uart0_asrpro =
{ .p_ctrl = &g_uart0_asrpro_ctrl, .p_cfg = &g_uart0_asrpro_cfg, .p_api = &g_uart_on_sci_b };
gpt_instance_ctrl_t g_timer_servo_tick_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_servo_tick_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_timer_servo_tick_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg             = &g_timer_servo_tick_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_servo_tick_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x4c4b40,
  .duty_cycle_counts = 0x2625a0, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback =
          g_timer_servo_tick_callback,
  ...
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_servo_tick_extend,
  .cycle_end_ipl = (12),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_servo_tick =
{ .p_ctrl = &g_timer_servo_tick_ctrl, .p_cfg = &g_timer_servo_tick_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_timer_servo_4_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_servo_4_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer_servo_4_extend =
        { .gtioca =
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT6_COMPARE_F,
          ...
          .capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_timer_servo_4_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_servo_4_cfg =
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 10%. */.period_counts = (uint32_t) 0x4c4b40,
  .duty_cycle_counts = 0x7a120, .source_div = (timer_source_div_t) 0, .channel = 6, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_servo_4_extend,
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_servo_4 =
{ .p_ctrl = &g_timer_servo_4_ctrl, .p_cfg = &g_timer_servo_4_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_timer_servo_23_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_servo_23_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer_servo_23_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT5_COMPARE_F,
          ...
          .capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_timer_servo_23_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_servo_23_cfg =
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 10%. */.period_counts = (uint32_t) 0x4c4b40,
  .duty_cycle_counts = 0x7a120, .source_div = (timer_source_div_t) 0, .channel = 5, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_servo_23_extend,
  .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_servo_23 =
{ .p_ctrl = &g_timer_servo_23_ctrl, .p_cfg = &g_timer_servo_23_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_timer_servo_01_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_servo_01_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer_servo_01_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT2_COMPARE_F,
          ...
          .capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_timer_servo_01_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_servo_01_cfg =
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 10%. */.period_counts = (uint32_t) 0x4c4b40,
  .duty_cycle_counts = 0x7a120, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = &g_timer_servo_01_extend,
  .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_servo_01 =
{ .p_ctrl = &g_timer_servo_01_ctrl, .p_cfg = &g_timer_servo_01_cfg, .p_api = &g_timer_on_gpt };
...
#endif
#undef RA_NOT_DEFINED
  .p_callback = g_i2c_master_callback,
  .p_context = NULL,
...
{ .capture_format = CEU_CAPTURE_FORMAT_DATA_SYNCHRONOUS,
  ...
  .interrupts_enabled = 0 | R_CEU_CEIER_CPEIE_Msk | 0 | 0 | R_CEU_CEIER_CDTOFIE_Msk | 0 | 0 | R_CEU_CEIER_VBPIE_Msk | 0
          | 0,
  .ceu_ipl = (10),
...
gpt_instance_ctrl_t g_timer_step1_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_step1_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer_step1_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          ...
          .count_up_source = (gpt_source_t) (GPT_SOURCE_NONE), .count_down_source = (gpt_source_t) (GPT_SOURCE_NONE), .capture_a_source =
                  (gpt_source_t) (GPT_SOURCE_NONE),
          .capture_b_source = (gpt_source_t) (GPT_SOURCE_NONE), .capture_a_ipl = (12), .capture_b_ipl = (12), .compare_match_c_ipl =
                  (BSP_IRQ_DISABLED),
          .compare_match_d_ipl = (BSP_IRQ_DISABLED), .compare_match_e_ipl = (BSP_IRQ_DISABLED), .compare_match_f_ipl =
                  (BSP_IRQ_DISABLED),
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT1_COMPARE_F,
          ...
          .capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_timer_step1_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 1
          .gtior_setting.gtior_b.gtioa = (0U << 4U) | (0U << 2U) | (3U << 0U),
          .gtior_setting.gtior_b.oadflt = (uint32_t) GPT_PIN_LEVEL_LOW, .gtior_setting.gtior_b.oahld = 1U, .gtior_setting.gtior_b.oae =
                  (uint32_t) true,
          ...
          .gtior_setting.gtior_b.nfcsa = ((uint32_t) GPT_CAPTURE_FILTER_NONE >> 1U), .gtior_setting.gtior_b.gtiob = (0U
                  << 4U) | (0U << 2U) | (3U << 0U),
          .gtior_setting.gtior_b.obdflt = (uint32_t) GPT_PIN_LEVEL_LOW, .gtior_setting.gtior_b.obhld = 1U, .gtior_setting.gtior_b.obe =
                  (uint32_t) true,
...
const timer_cfg_t g_timer_step1_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x61a8,
  .duty_cycle_counts = 0x30d4, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback =
          G_Timer_DelayElapsedCallback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_step1 =
{ .p_ctrl = &g_timer_step1_ctrl, .p_cfg = &g_timer_step1_cfg, .p_api = &g_timer_on_gpt };
sci_b_uart_instance_ctrl_t g_uart9_test_ctrl;

sci_b_baud_setting_t g_uart9_test_baud_setting =
        {
        /* Baud rate calculated with 0.160% error. */.baudrate_bits_b.abcse = 0,
          .baudrate_bits_b.abcs = 0, .baudrate_bits_b.bgdm = 1, .baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 64, .baudrate_bits_b.mddr =
                  (uint8_t) 256,
...
/** UART extended configuration for UARTonSCI HAL driver */
const sci_b_uart_extended_cfg_t g_uart9_test_cfg_extend =
{ .clock = SCI_B_UART_CLOCK_INT, .rx_edge_start = SCI_B_UART_START_BIT_FALLING_EDGE, .noise_cancel =
          SCI_B_UART_NOISE_CANCELLATION_DISABLE,
  .rx_fifo_trigger = SCI_B_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &g_uart9_test_baud_setting, .flow_control =
          SCI_B_UART_FLOW_CONTROL_RTS,
#if 0xFF != 0xFF
                .flow_control_pin       = BSP_IO_PORT_FF_PIN_0xFF,
                #else
...
/** UART interface configuration */
const uart_cfg_t g_uart9_test_cfg =
{ .channel = 9, .data_bits = UART_DATA_BITS_8, .parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
          g_uart9_testcallback,
  .p_context = NULL, .p_extend = &g_uart9_test_cfg_extend,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
  .p_transfer_tx = NULL,
#else
...
/* Instance structure to use this module. */
const uart_instance_t g_uart9_test =
{ .p_ctrl = &g_uart9_test_ctrl, .p_cfg = &g_uart9_test_cfg, .p_api = &g_uart_on_sci_b };
