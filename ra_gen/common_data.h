...
extern icu_instance_ctrl_t g_external_irq_VSYNC_ctrl;
extern const external_irq_cfg_t g_external_irq_VSYNC_cfg;

#ifndef external_irq_VSYNC_callback
void external_irq_VSYNC_callback(external_irq_callback_args_t *p_args);
#endif
/** External IRQ on ICU Instance. */
