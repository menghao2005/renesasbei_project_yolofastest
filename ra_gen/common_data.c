...
const icu_extended_cfg_t g_external_irq_VSYNC_ext_cfg =
{ .filter_src = EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq_VSYNC_cfg =
{ .channel = 8, .trigger = EXTERNAL_IRQ_TRIG_RISING, .filter_enable = false, .clock_source_div =
          EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64,
  .p_callback = external_irq_VSYNC_callback,
  ...
  .p_context = (void*) &NULL,
#endif
  .p_extend = (void*) &g_external_irq_VSYNC_ext_cfg,
  .ipl = (12),
...
const external_irq_instance_t g_external_irq_VSYNC =
{ .p_ctrl = &g_external_irq_VSYNC_ctrl, .p_cfg = &g_external_irq_VSYNC_cfg, .p_api = &g_external_irq_on_icu };
...
const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        { .p_mipi_phy_instance = &g_mipi_phy0,
          ...
          .vertical_back_porch = (12 - 2),
          .vertical_front_porch = (1124 - 800 - 12 - 2),
          ...
          .horizontal_back_porch = (42 - 2),
          .horizontal_front_porch = (564 - 480 - 42 - 2),
          .horizontal_sync_polarity = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

          .video_mode_delay = 119 /* This value was calculated by FSP. An override is available but not recommended for most users */,

          .hsa_no_lp = ((R_MIPI_DSI_VMSET0R_HSANOLP_Msk | R_MIPI_DSI_VMSET0R_HBPNOLP_Msk | 0x0)
                  & R_MIPI_DSI_VMSET0R_HSANOLP_Msk),
          .hbp_no_lp = ((R_MIPI_DSI_VMSET0R_HSANOLP_Msk | R_MIPI_DSI_VMSET0R_HBPNOLP_Msk | 0x0)
                  & R_MIPI_DSI_VMSET0R_HBPNOLP_Msk),
          .hfp_no_lp = ((R_MIPI_DSI_VMSET0R_HSANOLP_Msk | R_MIPI_DSI_VMSET0R_HBPNOLP_Msk | 0x0)
                  & R_MIPI_DSI_VMSET0R_HFPNOLP_Msk),
...
{ .tcon_hsync = GLCDC_TCON_PIN_1,
  ...
  .clock_div_ratio = GLCDC_PANEL_CLK_DIVISOR_5,
...
const display_cfg_t g_display_cfg =
        ...
        .input[0] =
        {
          ...
          .output =
                  { .htiming =
                  { .total_cyc = 564, .display_cyc = 480, .back_porch = 42, .sync_width = 2, .sync_polarity =
                            DISPLAY_SIGNAL_POLARITY_LOACTIVE },
                    .vtiming =
                    { .total_cyc = 1124, .display_cyc = 800, .back_porch = 12, .sync_width = 2, .sync_polarity =
                              DISPLAY_SIGNAL_POLARITY_LOACTIVE },
          ...
          .line_detect_ipl = (12),
          .underflow_1_ipl = (12), .underflow_2_ipl = (BSP_IRQ_DISABLED),
